...
C_root=Canvas(root, width=900,height=600, bg='#131313')
C_root.place(x=0,y=0)


#           _____________________________________
#__________/Se titulo de los Cuadros de texto
L_Titulo = Label(C_root,text="Mensajes Enviados",font=('Agency FB',14),bg='#131313',fg='white')
L_Titulo.place(x=140,y=10)

L_Titulo = Label(C_root,text="Respuesta Mensaje",font=('Agency FB',14),bg='#131313',fg='white')
...
L_Titulo = Label(C_root,text="Mensaje:",font=('Agency FB',14),bg='#131313',fg='white')
L_Titulo.place(x=100,y=250)

E_Command = Entry(C_root,width=30,font=('Agency FB',14))
E_Command.place(x=220,y=250)

L_Titulo = Label(C_root,text="ID mensaje:",font=('Agency FB',14),bg='#131313',fg='white')
L_Titulo.place(x=100,y=300)

E_read = Entry(C_root,width=30,font=('Agency FB',14))
E_read.place(x=220,y=300)
...
Btn_ConnectControl = Button(C_root,text='Send',command=lambda:send(None),fg='white',bg='#134596', font=('Agency FB',12))
#Btn_ConnectControl.place(x=450,y=250)
Btn_ConnectControl.place(x=590,y=250)

Btn_Controls = Button(C_root,text='Send & Show ID',command=sendShowID,fg='white',bg='#134596', font=('Agency FB',12), relief="flat")
#Btn_Controls.place(x=500,y=250)
Btn_Controls.place(x=665,y=250)

Btn_ConnectControl = Button(C_root,text='Leer Mensaje',command=read,fg='white',bg='#134596', font=('Agency FB',12))
#Btn_ConnectControl.place(x=450,y=300)
Btn_ConnectControl.place(x=590,y=300)
root.mainloop()
